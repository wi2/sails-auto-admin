...
module.exports = {
  home: function(req, res) {
    ...
    resTo(Routes(), req.wantsJSON, res, '/', {title:'Administration - Home'}, state);
  },
  new: function(req, res) {
    ...
    .then( result => {
      ...
      resTo(Routes(), req.wantsJSON, res, '/admin/'+req.param('identity')+'/new', {title:'Administration - create record'}, state);
    })
  },
  update: function(req, res) {
    ...
    .then( result => {
      ...
      resTo(Routes(), req.wantsJSON, res, '/admin/'+req.param('identity')+'/'+req.param('id'), {title:'Administration - update record'}, state);
    });
  },
  list: function(req, res) {
    ...
    query
      ...
      .then( result => {
        ...
        resTo(Routes(), req.wantsJSON, res, '/admin/'+req.param('identity'), {title:'Administration - List'}, state);
      });
  }
};
